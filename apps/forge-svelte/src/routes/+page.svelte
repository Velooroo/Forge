<script lang="ts">
	...
	import { Cpu, Github, ArrowRight, Sparkles } from 'lucide-svelte';
		...
		<div class="flex items-center justify-center">
			...
			>
              ...
              bg-gradient-to-tr from-emerald-400/80 to-cyan-400/80 shadow-lg shadow-emerald-500/15"
					...
					<form class="space-y-5" on:submit|preventDefault={() => handleAuth(email, password)}>
						<div class="space-y-2">
							<Label>Email</Label>
							<Input
						...
						<Button
							on:click={() => handleAuth(email, password)}
							type="submit"
						>
							Sign In
